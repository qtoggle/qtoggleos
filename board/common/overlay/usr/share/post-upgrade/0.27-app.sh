...
run_psql_cmd "SELECT id::BIGINT, (content->'pid')::TEXT AS oid, (content->'ts')::BIGINT AS ts, CASE WHEN content->'val' = 'false' THEN 0 WHEN content->'val' = 'true' THEN 1 ELSE (content->'val')::double precision END AS val INTO value_history FROM value_history_old;"
